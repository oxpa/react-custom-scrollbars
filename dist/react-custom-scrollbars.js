...
/***/ function(module, exports, __webpack_require__) {
	...
	exports["default"] = (0, _react.createClass)({
	    ...
	    propTypes: {
	        ...
	        onScrollAtTop: _react.PropTypes.func,
	        onScrollAtBottom: _react.PropTypes.func,
	        onScrollAtLeft: _react.PropTypes.func,
	        onScrollAtRight: _react.PropTypes.func,
	        ...
	        edgeXThreshold: _react.PropTypes.number,
	        edgeYThreshold: _react.PropTypes.number,
	    ...
	    getValues: function getValues() {
	        ...
	        var _props = this.props,
	            edgeXThreshold = _props.edgeXThreshold,
	            edgeYThreshold = _props.edgeYThreshold;
	    ...
	    handleScroll: function handleScroll(event) {
	        ...
	        var _props4 = this.props,
	            ...
	            onScrollAtTop = _props4.onScrollAtTop,
	            onScrollAtBottom = _props4.onScrollAtBottom,
	            onScrollAtLeft = _props4.onScrollAtLeft,
	            onScrollAtRight = _props4.onScrollAtRight;
	    ...
	    render: function render() {
	        ...
	        var _props6 = this.props,
	            ...
	            onScrollFrame = _props6.onScrollFrame,
	            onScrollAtTop = _props6.onScrollAtTop,
	            onScrollAtBottom = _props6.onScrollAtBottom,
	            onScrollStart = _props6.onScrollStart,
	            onScrollStop = _props6.onScrollStop,
	            onUpdate = _props6.onUpdate,
	            renderView = _props6.renderView,
	            renderTrackHorizontal = _props6.renderTrackHorizontal,
	            renderTrackVertical = _props6.renderTrackVertical,
	            renderThumbHorizontal = _props6.renderThumbHorizontal,
	            renderThumbVertical = _props6.renderThumbVertical,
	            tagName = _props6.tagName,
	            edgeThreshold = _props6.edgeThreshold,
	            hideTracksWhenNotNeeded = _props6.hideTracksWhenNotNeeded,
	            autoHide = _props6.autoHide,
	            autoHideTimeout = _props6.autoHideTimeout,
	            autoHideDuration = _props6.autoHideDuration,
	            thumbSize = _props6.thumbSize,
	            thumbMinSize = _props6.thumbMinSize,
	            universal = _props6.universal,
	            autoHeight = _props6.autoHeight,
	            autoHeightMin = _props6.autoHeightMin,
	            autoHeightMax = _props6.autoHeightMax,
	            style = _props6.style,
	            children = _props6.children,
	            props = _objectWithoutProperties(_props6, ['onScroll', 'onScrollFrame', 'onScrollAtTop', 'onScrollAtBottom', 'onScrollStart', 'onScrollStop', 'onUpdate', 'renderView', 'renderTrackHorizontal', 'renderTrackVertical', 'renderThumbHorizontal', 'renderThumbVertical', 'tagName', 'edgeThreshold', 'hideTracksWhenNotNeeded', 'autoHide', 'autoHideTimeout', 'autoHideDuration', 'thumbSize', 'thumbMinSize', 'universal', 'autoHeight', 'autoHeightMin', 'autoHeightMax', 'style', 'children']);
